...
#define GIMBAL_BIG_YAW              2  // 大yaw环云台
#define OLD_GIMBAL_YAW_PITCH_DIRECT 3  // 牢哨兵版yaw-pitch电机直连云台

// 可用的发射机构硬件类型
#define SHOOT_NONE               0  // 无发射机构
#define SHOOT_FRIC_TRIGGER       1  // 摩擦轮+拨弹盘发射机构
#define SHOOT_PNEUMATIC_TRIGGER  2  // 气动+拨弹盘发射机构
#define OLD_SHOOT_FRIC_TRIGGER   3  // 旧版摩擦轮+拨弹盘发射机构（牢哨兵怀旧版）
...
#define C_BOARD_OMNI_SENTRY_ROT_GIMBAL      9  // 双Yaw云台哨兵大Yaw+底盘 C板
#define C_BOARD_OMNI_SENTRY_AIM_GIMBAL      10 // 双Yaw云台哨兵小Yaw C板
