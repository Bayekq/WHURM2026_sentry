/**
  ...
  *  V1.1.0     Nov-25-2025     Bayekq          1. 添加dmIMU选择，加入Music模式开关
  *
  @verbatim
  ==============================================================================
...
//导入具体的机器人参数配置文件
// #include "robot_param_omni_old_sentry.h"
#include "robot_param_omni_sentry_gimbal.h"
